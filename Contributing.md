# Node-Gemini Contributor Guide

## Steps to add yourself to the contributers list.

1) You will first need git which you can download from [here](https://git-scm.com/downloads).

2) Now head [here](https://github.com/nishantapps/node-gemini) and click on the `fork` button.
...
6) Now you will see a folder named `node-gemini`, open it and edit the code of ``node-gemini`` and  the `README.md` file using any text editor, VScode for example.
